...
const whyChoose = [
  ...
  { icon: "ri-award-line", title: "Expert Handling", desc: "10+ years of GHMC, HMDA & TS-bPASS approval experience." },
...
export default function ServicePageLayout({ data }: { data: ServiceData }) {
  ...
  // Build the service page URL from the hero image alt / badge (slug derived from badge)
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
          ...
          <div className="max-w-3xl">
            ...
            <div className="hero-animate-4 flex flex-col sm:flex-row gap-4">
              <a href="https://wa.me/919980377877" target="_blank" rel="nofollow noreferrer"
