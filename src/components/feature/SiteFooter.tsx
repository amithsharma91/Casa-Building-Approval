...
const LOGO_URL = "https://storage.readdy-site.link/project_files/e935d4ba-d68c-4c45-9f24-abafaff5b522/69e504ae-1d02-4f4a-9d97-e2dccffcad40_IMG_20260326_061953.png?v=2b5af36d566732986a37d7ffeb35a4db";
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
          <div className="lg:col-span-1">
            ...
            <p className="text-sm text-white/45 leading-loose mb-6" style={{ fontFamily: '"DM Sans", sans-serif' }}>
              Expert building permission consultancy for GHMC, HMDA, and TS-bPASS approvals in Hyderabad, Telangana.
            </p>
            <div className="flex flex-col gap-3">
              <a href="tel:+919980377877" className="flex items-center gap-3 text-sm text-white/50 hover:text-white transition-colors cursor-pointer" style={{ fontFamily: '"DM Sans", sans-serif' }}>
                <span className="w-4 h-4 flex items-center justify-center"><i className="ri-phone-line text-xs" style={{ color: "#C8960C" }}></i></span>
                +91 99803 77877
              </a>
              <a href="mailto:ghmcbpservices@gmail.com" className="flex items-center gap-3 text-sm text-white/50 hover:text-white transition-colors cursor-pointer" style={{ fontFamily: '"DM Sans", sans-serif' }}>
          ...
          <div>
            ...
            <div className="flex flex-col gap-5 mb-7">
              <div className="flex items-start gap-3">
                ...
                <span className="text-sm text-white/45 leading-snug" style={{ fontFamily: '"DM Sans", sans-serif' }}>Hyderabad, Telangana, India</span>
              </div>
              <div className="flex items-start gap-3">
