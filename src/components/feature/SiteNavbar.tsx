        ...
        <div className="lg:hidden border-t" style={{ background: "#0B1F3A", borderColor: "rgba(200,150,12,0.3)" }}>
          <div className="px-4 py-5 flex flex-col gap-1">
            ...
            <div className="flex flex-col gap-2 mt-4 pt-4" style={{ borderTop: "1px solid rgba(200,150,12,0.3)" }}>
              <a href="tel:+919980377877" className="flex items-center justify-center gap-2 py-3 rounded-sm border text-white font-medium text-sm cursor-pointer whitespace-nowrap" style={{ borderColor: "rgba(200,150,12,0.5)" }}>
                <i className="ri-phone-line" style={{ color: "#C8960C" }}></i>
                +91 99803 77877
              </a>
              <a href="https://wa.me/919980377877" target="_blank" rel="nofollow noreferrer" className="flex items-center justify-center gap-2 py-3 rounded-sm bg-green-500 text-white font-semibold text-sm cursor-pointer whitespace-nowrap">
