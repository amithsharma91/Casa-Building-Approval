...
export default function FAQPage() {
  ...
  useEffect(() => {
    document.title =
      "FAQ – GHMC Building Permission & TS-bPASS Hyderabad | Casa Associates";
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc)
      metaDesc.setAttribute(
        "content",
        "Frequently asked questions about GHMC building permission, TS-bPASS approval, and HMDA layout permission in Hyderabad. Expert answers from Casa Associates — 500+ approvals, 98% success rate."
      );
    window.scrollTo(0, 0);
  }, [siteUrl]);
      ...
      "@graph": [
        {
          ...
          url: `${siteUrl}/faq`,
          name: "FAQ – GHMC Building Permission & TS-bPASS Hyderabad | Casa Associates",
          description:
            "Frequently asked questions about GHMC building permission, TS-bPASS approval, and HMDA layout permission in Hyderabad.",
          inLanguage: "en-IN",
          breadcrumb: {
            "@type": "BreadcrumbList",
            itemListElement: [
        ...
        },
        {
          ...
          mainEntity: [
            {
              "@type": "Question",
              name: "What is TS-bPASS?",
              acceptedAnswer: {
                "@type": "Answer",
                text: "TS-bPASS stands for Telangana State Building Permission Approval and Self-Certification System. It is an online platform launched by the Government of Telangana to streamline and simplify building permission approvals across GHMC, HMDA, and all municipal corporations in the state.",
              },
            },
            {
              "@type": "Question",
              ...
              acceptedAnswer: {
                "@type": "Answer",
                text: "Typically, GHMC building permission takes between 30 to 90 days depending on the plot size, type of construction, and completeness of documents. With the TS-bPASS system and Casa Associates handling your case, timelines are significantly reduced.",
              },
            },
            {
              "@type": "Question",
            ...
            },
            {
              ...
              acceptedAnswer: {
                "@type": "Answer",
                text: "Yes, you can apply directly through the TS-bPASS portal. However, the process involves complex document verification, technical scrutiny, plan compliance checks, and follow-ups with GHMC officers. A professional consultant like Casa Associates significantly reduces the risk of rejection and speeds up the approval timeline.",
              },
            },
            {
              "@type": "Question",
      ...
      <section className="relative pt-36 pb-24 overflow-hidden" style={{ background: "#0B1F3A" }}>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 text-center">
          ...
          <p className="text-lg text-white/70 max-w-2xl mx-auto leading-loose">
            Everything you need to know about GHMC building permissions, TS-bPASS approvals, and HMDA layout applications in Hyderabad.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-6 sm:px-8 lg:px-12">
          <div className="text-center mb-14">
            ...
            <p className="text-base text-gray-500">Clear answers to your most common questions about GHMC approvals and TS-bPASS in Hyderabad.</p>
          </div>
      ...
      <section className="py-20" style={{ background: "#0B1F3A" }}>
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <p className="text-base text-white/60 mb-8">
            Contact us on WhatsApp for free, personalized guidance on your GHMC building permission or TS-bPASS approval in Hyderabad.
          </p>
