      ...
      <div className="max-w-4xl mx-auto px-6 sm:px-8 lg:px-12">
        ...
        <div className="text-center mb-16">
          ...
          <p
            ...
            style={{ fontFamily: '"DM Sans", sans-serif' }}
          >
            Everything you need to know about GHMC building permissions, TS-bPASS approvals, and our services in Hyderabad.
          </p>
        </div>
        ...
        <div className="mt-12 text-center">
          <p
            className="text-base text-gray-400 mb-5"
            style={{ fontFamily: '"DM Sans", sans-serif' }}
          >
          ...
          <a
            ...
            className="inline-flex items-center gap-2 px-7 py-4 rounded-sm text-white text-sm font-semibold cursor-pointer transition-all hover:opacity-90 whitespace-nowrap"
