...
const services = [
  {
    ...
    subtitle: "GHMC / HMDA",
    desc: "End-to-end assistance for GHMC and HMDA building permission applications through TS-bPASS. We handle documentation, plan submission, fee payment, and final approval.",
    tag: "Most Popular",
    tagColor: "#C8960C",
    featured: true,
  ...
  },
  {
    ...
    desc: "If your land has been affected by road widening or HMDA projects, you may be eligible for TDR compensation. We help you file and claim your TDR entitlement.",
    tag: "Claim",
    tagColor: "#0B1F3A",
    featured: false,
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        ...
        >
          ...
          <a
            ...
            className="flex items-center gap-2 px-7 py-4 rounded-sm text-sm font-semibold whitespace-nowrap cursor-pointer transition-all hover:opacity-90 flex-shrink-0"
