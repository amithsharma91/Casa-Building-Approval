...
const testimonials = [
  {
    ...
    text: "Casa Associates made the GHMC building permission process completely stress-free. They handled all documents, plan drafting, and follow-ups professionally. Got my TS-bPASS approval within 60 days!",
    rating: 5,
  },
  {
