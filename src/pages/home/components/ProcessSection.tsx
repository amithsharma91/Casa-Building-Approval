const steps = [
  ...
  },
  {
    ...
    desc: "A licensed architect prepares the building plan in compliance with GHMC setback rules, FAR norms, and TS-bPASS guidelines.",
  },
  {
    num: "03",
    title: "TS-bPASS Submission",
    desc: "The complete application is submitted on the official TS-bPASS portal with all required documents and certifications.",
  },
  {
    num: "04",
    title: "Fee Payment",
    desc: "Applicable scrutiny fees and government charges are calculated and paid online through the TS-bPASS portal.",
  },
  {
    num: "05",
    title: "GHMC Scrutiny",
    ...
    <section id="process" className="py-24 lg:py-32" style={{ background: "#0B1F3A" }}>
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        ...
        <div className="text-center mb-16">
          ...
          >
            A transparent, step-by-step process — no hidden surprises. We walk you through every stage of your TS-bPASS building permission approval in Hyderabad.
          </p>
        </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {steps.slice(4).map((step, i) => (
            <StepCard key={step.num} step={step} highlight={i === 2} />
          ))}
        </div>
        ...
        <div className="mt-14 text-center">
          ...
          <a
            ...
            className="inline-flex items-center gap-3 px-9 py-4 rounded-sm font-semibold text-base cursor-pointer transition-all hover:opacity-90 whitespace-nowrap"
            style={{ background: "#C8960C", color: "#0B1F3A", fontFamily: '"DM Sans", sans-serif' }}
          >
            <span className="w-5 h-5 flex items-center justify-center">
              <i className="ri-whatsapp-line text-base"></i>
            </span>
            Start Your Application — Chat Now
          </a>
        </div>
      </div>
    </section>
