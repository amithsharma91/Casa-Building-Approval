...
const reasons = [
  ...
  },
  {
    ...
    desc: "Specialized knowledge of GHMC building permission rules, TS-bPASS system, and HMDA layout norms across Hyderabad.",
  },
  {
    ...
    <section id="why-choose" className="py-24 lg:py-32" style={{ background: "#F8F6F0" }}>
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        ...
        <div ref={headerRef} className="text-center mb-16">
          ...
          >
            With 500+ building approvals delivered across Hyderabad, we bring unmatched expertise in GHMC building permissions and TS-bPASS processes.
          </p>
        </div>
