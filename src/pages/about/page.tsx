...
const whyTrust = [
  { icon: "ri-shield-user-line", title: "Experienced Team", desc: "Over 10 years of handling GHMC, HMDA & TS-bPASS approvals." },
  ...
  useEffect(() => {
    ...
    if (metaDesc)
      metaDesc.setAttribute(
        "content",
        "Casa Associates — 10+ years of GHMC, HMDA & TS-bPASS approval expertise in Hyderabad. 500+ successful building approvals with 98% success rate. Trusted building permission consultancy."
      );
    window.scrollTo(0, 0);
  }, [siteUrl]);
      ...
      "@graph": [
        {
          ...
          description:
            "Casa Associates is a professional GHMC building permission and HMDA layout approval consultancy in Hyderabad with over 10 years of experience.",
          inLanguage: "en-IN",
      ...
      <section className="relative pt-36 pb-24 overflow-hidden" style={{ background: "#0B1F3A" }}>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 text-center">
          ...
          <p className="text-lg text-white/70 max-w-2xl mx-auto mb-10 leading-loose">
            Building Permission Experts in Hyderabad — trusted by hundreds of clients for GHMC, HMDA, and TS-bPASS approvals.
          </p>
          <a
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-base text-gray-600 leading-loose mb-6">
                Casa Associates is a professional consultancy providing building permission and approval services in Hyderabad. We specialize in <strong>GHMC, HMDA, and TS-bPASS approvals</strong> with a transparent and guided process.
              </p>
              <p className="text-base text-gray-600 leading-loose mb-8">
                With over 10 years of experience and 500+ successful approvals, our team handles everything from document checking to final certificate issuance — ensuring your project moves forward without delays or rejections.
              </p>
