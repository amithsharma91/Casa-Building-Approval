  ...
  useJsonLd(
    {
      ...
      "@graph": [
        ...
        },
        {
          ...
          description: "Complete checklist of documents needed for GHMC building permission and TS-bPASS approval in Hyderabad.",
          numberOfItems: 7,
          itemListElement: [
      ...
      <section className="relative pt-36 pb-24 overflow-hidden" style={{ background: "#0B1F3A" }}>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 text-center">
          ...
          <p className="text-lg text-white/70 max-w-2xl mx-auto mb-10 leading-loose">
            A complete checklist for GHMC building permission and TS-bPASS approval in Hyderabad. Our team guides you if any documents are missing.
          </p>
          <a
