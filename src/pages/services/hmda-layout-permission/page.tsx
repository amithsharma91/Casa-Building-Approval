...
const data: ServiceData = {
  ...
  servicesInclude: [
    ...
    { icon: "ri-computer-line", title: "HMDA Online Application", desc: "Complete filing of the layout permission application on TS-bPASS/HMDA portal." },
  ...
  process: [
    ...
    { title: "HMDA Application Filing", desc: "Submit the application with all documents via the HMDA / TS-bPASS portal." },
  ...
  faqs: [
    ...
    { q: "How long does HMDA layout approval take?", a: "HMDA layout permissions typically take 30-60 days depending on plot size, location, and the completeness of documents submitted. The TS-bPASS system has significantly streamlined this process." },
