...
const data: ServiceData = {
  ...
  heroSubtext: "Expert TDR consultancy in Hyderabad. We help property owners claim Transfer of Development Rights for road widening, use TDR for additional construction, and navigate the complete GHMC/HMDA approval process.",
  ...
  aboutParas: [
    ...
    "TDR is especially valuable in Hyderabad where the Master Plan includes extensive road widening lines. If part of your plot has been reserved for road widening, you are typically entitled to claim TDR. Casa Associates helps you understand your eligibility, apply for TDR certificates, and effectively utilize or sell these rights.",
  ],
  ...
  faqs: [
    ...
    { q: "Who is eligible for TDR in Hyderabad?", a: "Property owners in Hyderabad whose land has been acquired, reserved, or affected by road widening or public purpose reservations as per the GHMC/HMDA Master Plan are eligible to claim TDR as compensation." },
