...
const data: ServiceData = {
  ...
  metaDesc: "Expert GHMC building permission services in Hyderabad. We handle TS-bPASS applications, plan drafting, and approval tracking. Call +91 99803 77877.",
  ...
  heroSubtext: "Expert GHMC building permission consultancy in Hyderabad. We handle TS-bPASS applications, building plan drafting, and end-to-end approval tracking for your new construction or additional floors.",
  aboutHeading: "What is GHMC Building Permission?",
  aboutParas: [
    "GHMC (Greater Hyderabad Municipal Corporation) building permission is the legal approval required before starting any construction activity within Greater Hyderabad city limits. Under the TS-bPASS (Telangana State Building Permission Approval & Self Certification System), all applications are processed through a unified online portal ensuring speed and transparency.",
  ...
  servicesInclude: [
    ...
    { icon: "ri-computer-line", title: "TS-bPASS Online Submission", desc: "Complete filing of building permission application on the TS-bPASS portal with all required documents." },
  ...
  process: [
    ...
    { title: "TS-bPASS Application Filing", desc: "Complete online submission of your building permission application on TS-bPASS portal." },
  ...
  faqs: [
    ...
    { q: "How long does GHMC building permission take?", a: "Under TS-bPASS, plots up to 75 sq yards with G+1 floor receive instant self-certification approval. For larger projects, approval typically takes 15-30 working days after proper document submission and scrutiny." },
    { q: "What is TS-bPASS?", a: "TS-bPASS (Telangana State Building Permission Approval & Self Certification System) is the official online portal for processing all building permissions in Telangana. It ensures transparency, speed, and easy tracking of your application." },
    { q: "Is GHMC permission mandatory for small constructions?", a: "Yes. Any new construction or structural alteration within GHMC limits requires prior permission. However, plots up to 75 sq yards with Ground+1 floor qualify for the simplified self-certification route under TS-bPASS." },
    { q: "Can Casa Associates handle my complete GHMC application?", a: "Absolutely. We handle everything from document verification and plan drafting to TS-bPASS submission, fee payment, GHMC scrutiny follow-up, and final approval certificate collection — fully end-to-end." },
  ],
};
