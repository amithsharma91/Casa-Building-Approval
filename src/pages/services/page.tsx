...
const services = [
  {
    ...
    desc: "Complete assistance with building plan approvals through GHMC including documentation, TS-bPASS filing, fee payment, and approval tracking.",
...
const whyChoose = [
  {
    ...
    desc: "10+ years of specialized experience handling approvals across all municipal bodies in Hyderabad and Telangana.",
  },
  {
    icon: "ri-eye-line",
...
export default function ServicesPage() {
  ...
  useEffect(() => {
    document.title = "Building Approval Services Hyderabad | GHMC, HMDA, TS-bPASS | Casa Associates";
    const meta = document.querySelector('meta[name="description"]');
    if (meta) meta.setAttribute("content", "Casa Associates offers complete building approval services in Hyderabad — GHMC building permission, HMDA layout approval, TS-bPASS applications, occupancy certificates, TDR services, and road widening checks.");
    window.scrollTo(0, 0);
  }, [siteUrl]);
      ...
      "@graph": [
        {
          ...
          name: "Building Approval Services Hyderabad | GHMC, HMDA, TS-bPASS | Casa Associates",
          description:
            "Complete building approval services in Hyderabad — GHMC building permission, HMDA layout approval, TS-bPASS, occupancy certificates, TDR services, and road widening checks.",
          inLanguage: "en-IN",
          breadcrumb: {
            "@type": "BreadcrumbList",
            itemListElement: [
      ...
      <section className="relative pt-36 pb-28 overflow-hidden" style={{ background: "#0B1F3A" }}>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 text-center">
          ...
          <p className="text-lg text-white/70 max-w-2xl mx-auto mb-6 leading-loose">
            We provide complete assistance for <strong className="text-white/90">GHMC, HMDA, and TS-bPASS approvals</strong> with expert guidance, transparent process, and fast turnaround.
          </p>
        ...
        <div className="max-w-5xl mx-auto px-6 sm:px-8 lg:px-12 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-6 mt-10">
            {[
              ...
              { icon: "ri-timer-2-line", text: "10+ Years Experience" },
