...
const steps = [
  ...
  {
    num: "03",
    title: "TS-bPASS Application Submission",
    desc: "We file the complete TS-bPASS online application with all required documents, ensuring accuracy to avoid rejections or delays.",
...
export default function ProcessPage() {
  ...
  useEffect(() => {
    document.title =
      "GHMC Building Permission Process Hyderabad | TS-bPASS Steps | Casa Associates";
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc)
      metaDesc.setAttribute(
        "content",
        "Step-by-step GHMC building permission and TS-bPASS approval process in Hyderabad. Casa Associates handles all 7 steps — from document checking to approval certificate issuance."
      );
    window.scrollTo(0, 0);
  }, [siteUrl]);
      ...
      "@graph": [
        {
          ...
          url: `${siteUrl}/process`,
          name: "GHMC Building Permission Process Hyderabad | TS-bPASS Steps | Casa Associates",
          description:
            "Complete 7-step GHMC building permission and TS-bPASS approval process in Hyderabad managed by Casa Associates.",
          inLanguage: "en-IN",
          breadcrumb: {
            "@type": "BreadcrumbList",
            itemListElement: [
        ...
        },
        {
          ...
          description:
            "Complete step-by-step guide for obtaining GHMC building permission and TS-bPASS approval in Hyderabad, Telangana.",
          totalTime: "P90D",
          ...
          step: [
            ...
            },
            {
              "@type": "HowToStep",
              position: 3,
              name: "TS-bPASS Application Submission",
              text: "File the complete TS-bPASS online application with all required documents, ensuring accuracy to avoid rejections or delays.",
            },
            {
              "@type": "HowToStep",
              position: 4,
      ...
      <section className="relative pt-36 pb-24 overflow-hidden" style={{ background: "#0B1F3A" }}>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 text-center">
          ...
          <p className="text-lg text-white/70 max-w-2xl mx-auto mb-10 leading-loose">
            Step-by-step guidance for TS-bPASS and HMDA approvals in Hyderabad. Casa Associates handles the entire process from start to finish.
          </p>
          <a
        ...
        <div className="max-w-5xl mx-auto px-6 sm:px-8 lg:px-12">
          <div className="text-center mb-14">
            ...
            <p className="text-base text-gray-500 max-w-xl mx-auto">
              Casa Associates handles the entire GHMC building permission process — start to finish — for a smooth and fast TS-bPASS approval in Hyderabad.
            </p>
          </div>
